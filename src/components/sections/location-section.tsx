...
const locationDetails = [
  { Icon: MapPin, title: "Direccion", value: business.address },
...
function MapFrame() {
  return (
    <div className="relative min-h-[420px] overflow-hidden bg-[#f4f7fc] lg:min-h-[760px]" aria-label={`Mapa de ubicacion de ${business.businessName} en ${business.address}`}>
      <iframe
    ...
    <section id="ubicacion" className="bg-white text-foreground">
      <div className="grid gap-0 lg:grid-cols-[1.22fr_0.78fr] lg:items-stretch">
        ...
        <div className="self-center px-6 py-16 md:px-12 md:py-24 lg:px-16">
          <p className="mb-5 text-[12px] tracking-[0.16em] uppercase text-primary" style={mono}>Ubicacion</p>
          <h2 className="text-balance font-normal leading-[0.95] tracking-[-0.02em] text-foreground" style={{ ...serif, fontSize: "clamp(2.6rem, 7vw, 5rem)" }}>
            Bulnes, atencion cercana y agenda directa.
          </h2>
          <p className="mt-7 max-w-[460px] text-[15px] leading-[1.8] text-foreground/62">
            Estamos en {business.address}. Escribenos por WhatsApp o llama para coordinar tu atencion.
          </p>
          ...
          <div className="mt-12 grid gap-6">
            ...
            <div className="flex gap-4 border-t border-foreground/10 pt-5">
              ...
              <div>
                <p className="text-[11px] tracking-[0.15em] uppercase text-foreground/36" style={mono}>Atencion</p>
                <p className="mt-2 text-[15px] leading-relaxed text-foreground/68">Consulta y optica en un mismo lugar</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            ...
            <a href={directionsUrl} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 border border-foreground/14 px-5 py-3.5 text-[13px] tracking-wide text-foreground transition hover:border-foreground/34">
              <Navigation size={15} /> Como llegar
            </a>
          </div>
        </div>
      </div>
      ...
      <div id="agendar" className="bg-[#0c1628] px-6 py-16 text-white md:px-12 md:py-20 lg:px-16">
        <div className="mx-auto max-w-[980px] text-center">
          ...
          <h2 className="mt-8 text-balance font-normal leading-[0.95] tracking-[-0.02em] text-white" style={{ ...serif, fontSize: "clamp(2.7rem, 8vw, 5.8rem)" }}>
            OftaLife te acompana dia a dia.
          </h2>
          <p className="mx-auto mt-6 max-w-[560px] text-[16px] leading-[1.8] text-white/58">
            Agenda una consulta o escribenos por WhatsApp. Te ayudamos a encontrar una solucion visual comoda, precisa y coherente con tu rutina.
          </p>
